...
/**
 * Consumable object that keeps track of drinks by expiry date
 */
public class Drink implements Consumable{
    ...
    public Drink(String name, String notes, double price, double quantity, LocalDateTime expiryDate) {
        this.type = Consumable.DRINK;
        this.name = name;
        this.notes = notes;
        this.price = price;
    ...
    public String toString() {
        ...
        return  "<html>" +
                "<br/>Name: " + name.replaceAll("_"," ") +
                "<br/>Notes: " + notes.replaceAll("_"," ") +
